...
/**
 * Transformer to convert data to Title Case
 *
 ...
 */
class ToTitleCase implements TransformerInterface
{
    /**
    ...
    public function transform(
        ...
        return $this->changeCaseTransformer->transform(
            ...
            arguments: $this->argumentIteratorFactory->create([
                ChangeCaseArgumentProvider::ARGUMENT_INDEX_CASE => Cases::TITLECASE,
            ]),
            context: $context,
        );
    }
