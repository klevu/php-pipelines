...
/**
 * Transformer to divide current payload by numeric value
 * Arguments:
 *  - <numeric> Value
 *
 * @see CalcTransformer
 ...
 */
class Divide implements TransformerInterface
{
    ...
    public function transform(
        ...
        return $this->calcTransformer->transform(
            ...
            arguments: $this->argumentIteratorFactory->create([
                CalcArgumentProvider::ARGUMENT_INDEX_OPERATION => Operations::DIVIDE,
