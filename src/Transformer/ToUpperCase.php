...
/**
 * Transformer to convert data to UPPERCASE
 *
 ...
 */
class ToUpperCase implements TransformerInterface
{
    /**
    ...
    public function transform(
        ...
        return $this->changeCaseTransformer->transform(
            ...
            arguments: $this->argumentIteratorFactory->create([
                ChangeCaseArgumentProvider::ARGUMENT_INDEX_CASE => Cases::UPPERCASE,
            ]),
            context: $context,
        );
    }
