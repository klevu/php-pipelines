...
/**
 * Transformer to raise payload to the power of numeric exponent
 * Arguments:
 *  - <numeric> Value
 *
 * @see CalcTransformer
 ...
 */
class Pow implements TransformerInterface
{
    final public const ARGUMENT_INDEX_EXPONENT = 0;
    ...
    public function transform(
        ...
        $valueArgument = $arguments?->getByKey(self::ARGUMENT_INDEX_EXPONENT);

        return $this->calcTransformer->transform(
            data: $data,
            arguments: $this->argumentIteratorFactory->create([
                CalcArgumentProvider::ARGUMENT_INDEX_OPERATION => Operations::POW,
