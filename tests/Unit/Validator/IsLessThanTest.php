...
use Klevu\Pipelines\Validator\IsLessThan;
 ...
 *
 * @method IsLessThan initialiseTestObject()
 */
#[CoversClass(IsLessThan::class)]
class IsLessThanTest extends AbstractValidatorTestCase
{
    /**
     * @var string
     */
    protected string $validatorFqcn = IsLessThan::class;
        ...
        return array_map(
            callback: static fn (mixed $data): array => [
                ...
                $argumentIteratorFactory->create(
                    array_filter(
                        array: [
                            IsLessThan::ARGUMENT_INDEX_VALUE => $data[1], // @phpstan-ignore-line
                        ],
    ...
    public function testValidate_Invalid_ArgumentType(
        ...
        $validator->validate(
            ...
            arguments: $argumentIteratorFactory->create(
                [
                    IsLessThan::ARGUMENT_INDEX_VALUE => $argumentValue,
                ],
            ),
        );
    }
