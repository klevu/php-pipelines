...
use Klevu\Pipelines\Validator\DoesNotContain;
 ...
 *
 * @method DoesNotContain initialiseTestObject()
 */
#[CoversClass(DoesNotContain::class)]
class DoesNotContainTest extends AbstractValidatorTestCase
{
    /**
     * @var string
     */
    protected string $validatorFqcn = DoesNotContain::class;
        ...
        return array_map(
            callback: static fn (mixed $data): array => [
                ...
                $argumentIteratorFactory->create(
                    array_filter(
                        array: [
                            DoesNotContain::ARGUMENT_INDEX_NEEDLE => $data[1],
                            DoesNotContain::ARGUMENT_INDEX_STRICT => $strict,
                        ],
