...
use Klevu\Pipelines\Validator\IsGreaterThan;
 ...
 *
 * @method IsGreaterThan initialiseTestObject()
 */
#[CoversClass(IsGreaterThan::class)]
class IsGreaterThanTest extends AbstractValidatorTestCase
{
    /**
     * @var string
     */
    protected string $validatorFqcn = IsGreaterThan::class;
        ...
        return array_map(
            callback: static fn (mixed $data): array => [
                ...
                $argumentIteratorFactory->create(
                    array_filter(
                        array: [
                            IsGreaterThan::ARGUMENT_INDEX_VALUE => $data[1], // @phpstan-ignore-line
                        ],
    ...
    public function testValidate_Invalid_ArgumentType(
        ...
        $validator->validate(
            ...
            arguments: $argumentIteratorFactory->create(
                [
                    IsGreaterThan::ARGUMENT_INDEX_VALUE => $argumentValue,
                ],
            ),
        );
    }
