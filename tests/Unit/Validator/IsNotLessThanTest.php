...
use Klevu\Pipelines\Validator\IsNotLessThan;
 ...
 *
 * @method IsNotLessThan initialiseTestObject()
 */
#[CoversClass(IsNotLessThan::class)]
class IsNotLessThanTest extends AbstractValidatorTestCase
{
    /**
     * @var string
     */
    protected string $validatorFqcn = IsNotLessThan::class;
    ...
    public static function dataProvider_testValidate_Valid(): array
    {
        return array_merge(
            ...
            self::dataProvider_testValidate_InvalidData_Equal(),
        );
    }
     ...
     * @return mixed[][]
     */
    private static function dataProvider_testValidate_InvalidData_Equal(): array
    {
        return self::convertFixtures(
            fixtures: [
                [42, 42],
        ...
        return array_map(
            callback: static fn (mixed $data): array => [
                ...
                $argumentIteratorFactory->create(
                    array_filter(
                        array: [
                            IsNotLessThan::ARGUMENT_INDEX_VALUE => $data[1], // @phpstan-ignore-line
                        ],
    ...
    public function testValidate_Invalid_ArgumentType(
        ...
        $validator->validate(
            ...
            arguments: $argumentIteratorFactory->create(
                [
                    IsNotLessThan::ARGUMENT_INDEX_VALUE => $argumentValue,
                ],
            ),
        );
    }
