...
use Klevu\Pipelines\Validator\IsEqualTo;
 ...
 *
 * @method IsEqualTo initialiseTestObject()
 */
#[CoversClass(IsEqualTo::class)]
class IsEqualToTest extends AbstractValidatorTestCase
{
    /**
     * @var string
     */
    protected string $validatorFqcn = IsEqualTo::class;
        ...
        return array_map(
            callback: static fn (mixed $data): array => [
                ...
                $argumentIteratorFactory->create(
                    array_filter(
                        array: [
                            IsEqualTo::ARGUMENT_INDEX_VALUE => $data[1], // @phpstan-ignore-line
                            IsEqualTo::ARGUMENT_INDEX_STRICT => $strict,
                        ],
